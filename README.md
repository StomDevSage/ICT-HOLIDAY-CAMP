...
## Features
- 🎨 3D animated background with ICT-themed moving objects
- 📱 Fully responsive (mobile-first design)
- 📝 Registration form with ICT skill assessment questions
- 💳 Multiple payment methods (MTN MoMo, Airtel Money, PayPal, BK Card - coming soon)
- 📢 WhatsApp share integration
- 🧭 Smooth scroll navigation
- 💾 LocalStorage registration storage
